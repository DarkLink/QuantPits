...
| `ensemble/` | Ensemble fusion 的 service、I/O 与确定性分析层：显式配置加载、workspace-bound 执行路径、plan/render、manifest、OperatorLog linkage、预测持久化、fusion ledger、correlation/LOO analytics 与执行生命周期 | 融合 |
