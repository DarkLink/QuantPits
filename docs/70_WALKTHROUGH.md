...
推荐使用 [investment_data](https://github.com/chenditc/investment_data) 项目，该项目的 GitHub Releases 页面会持续发布最新的 Qlib 格式行情数据：

1. 前往 https://github.com/chenditc/investment_data/releases
2. 下载最新的 `qlib_bin.tar.gz`
3. 解压到 Qlib 数据目录：
